...
idp1 = os.getenv("OIDC1", "https://oidc1:8443/auth/realms/mockrealm/protocol/openid-connect")
idp2 = os.getenv("OIDC2", "https://oidc2:8443/auth/realms/mockrealm/protocol/openid-connect")
