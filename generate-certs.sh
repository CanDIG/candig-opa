...
openssl x509 -req -in permissions_shim/tls.csr -CA rootCA.crt -CAkey rootCA.key -CAcreateserial -out permissions_shim/tls.crt -days 500 -sha256 -extfile permissions_shim/shim.v3.ext
